...
では、これが必要条件になっていることを示す。つまり、
\(0 = x_{1}\oplus\dots\oplus x_{8}\)である時に、条件を満たす \(y_i\)が存在することを示す。
これは吐き出し法で解ける。\(y_{5},y_{6},y_{8},y_{9},y_{11}\)を自由変数として、以下のように \(y_i\)を構成できる。
\begin{align}
...
\[
\xymatrix{
    & & x_{1} \ar@{-}[ddd]|(0.66)\hole \ar@{-}[rr] \ar@{-}[dl] & & x_{2} \ar@{-}[ddd]|(0.66)\hole \ar@{-}[rr] \ar@{-}[dl] & & x_{3} \ar@{-}[ddd] \ar@{-}[dl]  \\
    & x_{4} \ar@{-}[ddd] \ar@{-}[rr] \ar@{-}[dl] & & x_{5} \ar@{-}[ddd] \ar@{-}[rr] \ar@{-}[dl] & & x_{6} \ar@{-}[ddd] \ar@{-}[dl] \\
    x_{7} \ar@{-}[ddd] \ar@{-}[rr] & & x_{8} \ar@{-}[ddd]|(0.33)\hole \ar@{-}[rr] & & x_{9} \ar@{-}[ddd]|(0.33)\hole \\

    & & x_{10} \ar@{-}[ddd]|(0.66)\hole \ar@{-}[rr] \ar@{-}[dl] & & x_{11} \ar@{-}[ddd]|(0.66)\hole \ar@{-}[rr] \ar@{-}[dl] & & x_{12} \ar@{-}[ddd] \ar@{-}[dl]  \\
    & x_{13} \ar@{-}[ddd] \ar@{-}[rr] \ar@{-}[dl] & & x_{14} \ar@{-}[ddd] \ar@{-}[rr] \ar@{-}[dl] & & x_{15} \ar@{-}[ddd] \ar@{-}[dl] \\
    x_{16} \ar@{-}[ddd] \ar@{-}[rr] & & x_{17} \ar@{-}[ddd]|(0.33)\hole \ar@{-}[rr] & & x_{18} \ar@{-}[ddd]|(0.33)\hole \\
    
    & & x_{19} \ar@{-}[rr] \ar@{-}[dl] & & x_{20} \ar@{-}[rr] \ar@{-}[dl] & & x_{21} \ar@{-}[dl]  \\
    & x_{22} \ar@{-}[rr] \ar@{-}[dl] & & x_{23} \ar@{-}[rr] \ar@{-}[dl] & & x_{24} \ar@{-}[dl] \\
