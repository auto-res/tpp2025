...
このとき、掃き出し法によって解が存在するのは、右辺が1になるときである。

\[
\bigoplus_{\substack{x=x_1,x_2\\y=y_1,y_2\\z=z_1,z_2}}\lnot x_{x,y,z}=1 \iff \bigoplus_{\substack{x=x_1,x_2\\y=y_1,y_2\\z=z_1,z_2}} x_{x,y,z}=1
\]

したがって、この条件が必要十分条件となる。

\[\bigwedge_{\substack{1\le x_1 < x_2 \le n\\1\le y_1 < y_2 \le n\\1\le z_1 < z_2 \le n}} \bigoplus_{\substack{x=x_1,x_2\\y=y_1,y_2\\z=z_1,z_2}}x_{x,y,z}=1\]
